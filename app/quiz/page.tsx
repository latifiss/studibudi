  ...
  return (
    <div className="flex h-dvh min-h-0 max-h-dvh w-full overflow-hidden bg-white">
      <div className={cn('flex h-full min-h-0 w-full flex-col overflow-hidden', showExplanation && !isMobile && 'min-w-0 flex-1')}>
        ...
        <main className="mx-auto flex min-h-0 w-full max-w-[600px] flex-1 flex-col items-center justify-center overflow-hidden px-4 py-0 sm:px-6 sm:py-0 md:-translate-y-[12px]">
          <h2 className="mb-3 line-clamp-3 w-full shrink-0 overflow-hidden px-2 text-center font-display text-[20px] font-bold leading-[27px] text-[#333333] sm:mb-5 sm:px-0 md:mb-2 md:text-[28px] md:leading-[38px]">{currentQuestion.question}</h2>
