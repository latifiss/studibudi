    ...
    <>
      ...
      >
        ...
        <div
          ...
          style={{ backgroundImage: `url("data:image/svg+xml,%3csvg width='100%25' height='100%25' xmlns='http://www.w3.org/2000/svg'%3e%3crect width='100%25' height='100%25' fill='none' stroke='%23737373' stroke-width='1.5' stroke-dasharray='8 8' stroke-dashoffset='0' stroke-linecap='square' rx='12'/%3e%3c/svg%3e")` }}
        >
          <div className={cn('flex flex-col items-center justify-center w-full h-full', isAlternate ? 'max-w-[320px]' : 'max-w-[189.98px] sm:max-w-[320px] lg:max-w-[320px]')}>
            ...
            <div className={cn('flex flex-col items-start', isAlternate ? 'pt-2 sm:pt-3 w-[120px]' : 'pt-1 sm:pt-2 lg:pt-3 w-[70px] sm:w-[120px] lg:w-[137px]')}>
              <button
                ...
                disabled={isLoading}
                className={cn('flex items-center justify-center bg-[#4F4CF0] text-white rounded-lg font-text font-semibold shadow-[0px_8px_16px_-12px_rgba(0,0,0,0.8),0px_12px_16px_-12px_rgba(79,76,240,0.64),inset_0px_-2px_0px_rgba(0,0,0,0.1),inset_0px_2px_0px_rgba(255,255,255,0.25)] hover:opacity-90 transition-opacity disabled:opacity-50 w-full', isAlternate ? 'h-[40px] sm:h-[44px] lg:h-[48px] text-[14px] sm:text-[16px] lg:text-[18px]' : 'h-[24px] sm:h-[40px] lg:h-[48px] text-[9px] sm:text-[14px] lg:text-[18px]')}
              >
                Choose file
              </button>
            </div>
