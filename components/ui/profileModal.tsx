...
const ProfileModal = ({
  ...
  const tierColor =
    tier === 'free' ? 'text-[#737373]' : 'text-[#4F4CF0]'

  return (
    <div
      ref={modalRef}
      className="fixed z-[60] w-70"
      style={{
        top: position.top,
    ...
    >
      ...
      >
        <div className="flex items-center gap-3 px-5 py-4 border-b border-[#E5E5E5] dark:border-[#2a2a3e]">
          <div className="w-10 h-10 rounded-full bg-[#F5F5F5] dark:bg-[#2a2a3e] flex items-center justify-center overflow-hidden">
