...
interface ClaudeLightIconProps extends SVGProps<SVGSVGElement> {
  size?: number
}

const ClaudeLightIcon = ({ 
  size = 24, 
  ...props 
}: ClaudeLightIconProps) => {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#claude-light-icon-clip)">
        <path
          fill="#D97757"
      ...
      <defs>
        <clipPath id="claude-light-icon-clip">
...
export default ClaudeLightIcon