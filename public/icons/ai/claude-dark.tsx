...
interface ClaudeDarkIconProps extends SVGProps<SVGSVGElement> {
  size?: number
}

const ClaudeDarkIcon = ({ 
  size = 24, 
  ...props 
}: ClaudeDarkIconProps) => {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#claude-dark-icon-clip)">
        <path
          fill="#D97757"
      ...
      <defs>
        <clipPath id="claude-dark-icon-clip">
