...
interface OpenaiLightIconProps extends SVGProps<SVGSVGElement> {
  size?: number
}

const OpenaiLightIcon = ({ 
  size = 24, 
  ...props 
}: OpenaiLightIconProps) => {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#openai-light-icon-clip)">
        <mask
          id="openai-light-icon-mask"
          width={24}
          height={24}
          x={0}
          y={0}
        ...
        <g mask="url(#openai-light-icon-mask)">
          <path
            fill="#000"
            fillRule="evenodd"
      ...
      <defs>
        <clipPath id="openai-light-icon-clip">
...
export default OpenaiLightIcon