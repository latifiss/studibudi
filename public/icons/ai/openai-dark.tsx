...
interface OpenaiDarkIconProps extends SVGProps<SVGSVGElement> {
  size?: number
}

const OpenaiDarkIcon = ({ 
  size = 24, 
  ...props 
}: OpenaiDarkIconProps) => {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#openai-dark-icon-clip)">
        <mask
          id="openai-dark-icon-mask"
          width={24}
          height={24}
          x={0}
          y={0}
        ...
        <g mask="url(#openai-dark-icon-mask)">
          <path
            fill="#fff"
            fillRule="evenodd"
      ...
      <defs>
        <clipPath id="openai-dark-icon-clip">
